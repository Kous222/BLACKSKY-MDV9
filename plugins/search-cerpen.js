/*
   Created By Dana
   Source From: https://github.com/DanaPutra133/Aquabot-V3/blob/spielen/aqua%20bot/plugins/search-cerpen.js
...
let handler = async (m, {conn, command}) => {
    ...
    try {
        ...
        console.log(e);
        m.Antworten('Entschuldigung, cerpen nicht in finden');
