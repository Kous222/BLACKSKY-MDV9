...
`
        ...
        setTimeout(() => {
            m.reply('Ziel gefunden!')
        }, 10000)

        setTimeout(() => {
            m.reply('Suche nach Beute...')
        }, 0)
        user.lastberburu = new Date * 1
    } else {
        m.reply(`\nEs scheint, dass du bereits erschöpft bist. Bitte mache eine Pause von etwa *${timers}*, bevor du wieder jagen kannst.`)
    }
}

handler.help = ['jagen']
handler.tags = ['rpg']
handler.command = /^(jagen|hunt)$/i
handler.rpg = true
