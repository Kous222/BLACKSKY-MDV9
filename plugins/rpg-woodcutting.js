...
let handler = async (m, { conn, usedPrefix, text }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastnebang< 28800000) throw `Du hackst bereits Holz\nBitte warte ${msToTime(time - new Date())} bevor du wieder Holz hacken kannst`
...
handler.help = ['nebang', 'holzhacken', 'woodcutting', 'chopwood']
handler.tags = ['rpg']
handler.command = /^(nebang|holzhacken|woodcutting|chopwood)/i
handler.group = true
handler.rpg = true
handler.fail = null
handler.limit = true
