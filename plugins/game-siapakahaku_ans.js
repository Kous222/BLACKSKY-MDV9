...
handler.before = async function (m) {
    ...
    if (!m.quoted || !m.quoted.fromMe || !m.quoted.isBaileys || !/Tippe.*werich/i.test(m.quoted.text)) return !0
    this.siapakahaku = this.siapakahaku ? this.siapakahaku : {}
    if (!(id in this.siapakahaku)) return m.reply('Diese Frage ist bereits beendet')
