...
handler.before = async function (m) {
    ...
    if (!m.quoted || !m.quoted.fromMe || !m.quoted.isBaileys || !/Tippe.*hinweis|tipp/i.test(m.quoted.text)) return !0
    this.merdeka = this.merdeka ? this.merdeka : {}
    if (!(id in this.merdeka)) return m.reply('Die Fragerunde ist beendet')
