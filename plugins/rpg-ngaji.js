...
`
        ...
        var dimas4 = `
Ngasih tau, kalo qalqalah das dipantulkan
`
...
`
        ...
        setTimeout(() => {
            conn.reply(m.chat, `suchen Guru Ngaji.....`, m)
        }, 0) 
        user.lastngaji = Date.now()
    } else {
        let clock = clockString(timers)
        conn.reply(m.chat, `Sepertinya du bereits Kecapekan Bitte Pause Dulu während\n*${clock}*`, m)
    }
}
